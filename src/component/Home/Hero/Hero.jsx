        ...
        <Grid container spacing={4}>
            ...
            >
                <Box
                    ...
                    height={1}
                    width={1}
                    src={'https://img.freepik.com/premium-vector/auditing-tax-accounting-banner-auditor-holds-magnifying-glass-hand-checks-financial-report-with-charts-calculator-laptop-flat-style-icons-isolated-vector-illustration_108855-2663.jpg?w=740'}
                    alt="..."
                    effect="blur"
                    boxShadow={3}
                    borderRadius={2}
