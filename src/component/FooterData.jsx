...
export const footerInfo = [
    {icon: faBuffer, info1: 'SANGAM CONSULTING', id: 1},
    {icon: faMobileAlt, info1: '8861467174', info2: 'reach2girishbr@gmail.com', id: 2},
    {icon: faMapMarkedAlt, info1: 'India', info2: 'Bangalore', id: 3}
];